...
#'
#' Following Chris Sims, this uses the recommendation of Ratcliff & Tuerlinckx (2002)
...
#' the rejection level, as well as keepVect, a vector tagging which RTs to keep. NOTE: 
